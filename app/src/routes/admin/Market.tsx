            ...
            return [
                ...state.map((model, idx) => {
                    if (idx === action.payload.idx) {
                        return {
                            ...model,
                            high_context: action.payload.context
                        };
                    }
                    return model;
                })
...
function MarketItem({
    ...
    const checked = useMemo(
        (): boolean =>
            model.id.trim().length > 0 && model.name.trim().length > 0,
        [model]
    );
            ...
            <div className={`model-wrapper`}>
                ...
                <div className={`market-row`}>
                    <span>
                        ...
                        <Tips
                            content={t('admin.market.model-is-default-tip')}
                        />
                    </span>
                    <Switch
                        className={`ml-auto`}
...
function SyncDialog({
    ...
    const newModels = useMemo(
        (): string[] =>
            siteModels.filter(model => !existModels.includes(model)),
            ...
            >
                <DialogContent>
                    ...
                    <DialogFooter>
                        ...
                        >
                            {t('admin.market.sync-all', {
                                length: newModels.length
                            })}
                        </Button>
                        <Button
                            loading={true}
    ...
    return (
        <div className={`market`}>
            ...
            <Card className={`admin-card market-card`}>
                ...
                <CardContent>
                    <div
                        className={`market-actions flex flex-row items-center mb-4`}
                    >
                        <Button
                            variant={`outline`}
                            ...
                            {provided => (
                                ...
                                >
                                    {form.length > 0 ? (
                                        ...
                                        <p
                                            className={`align-center text-sm empty`}
                                        >
                                            {t('admin.empty')}
                                        </p>
                                    )}
                    ...
                    <div
                        className={`market-footer flex flex-row items-center mt-4`}
                    >
                        <div className={`grow`} />
                        <Button
                            size={`sm`}

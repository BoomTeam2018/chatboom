...
export const deeptrainAppName =
    import.meta.env.VITE_DEEPTRAIN_APP || 'chatboom';
...
export function setDocsUrl(url: string): void {
     ...
     */
    url = url.trim() || 'https://docs.chatboom.net';
...
export function setBlobEndpoint(endpoint: string): void {
     ...
     */
    endpoint = endpoint.trim() || 'https://blob.chatboom.net';

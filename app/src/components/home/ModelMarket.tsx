        ...
        case tokenBilling:
            return (
                <>
                    <span className={className}>
                        <UploadCloud
                            className={`h-4 w-4 mr-1 translate-y-[1px]`}
                        />
                    ...
                    {mobile ? (
                        <Tips className={`market-tip`}>
                            ...
                            >
                                ...
                                <Badge
                                    className={`badge whitespace-nowrap mt-2`}
                                >
                                    {model.id}
                                </Badge>
                            </div>
                ...
                <Button
                    ...
                    onClick={e => {
                        ...
                        if (state === 0) dispatch(closeMarket());
                            ...
                            dispatch(removeModelList(model.id));
...
function MarketHeader() {
    ...
    return (
        <div className={`market-header`}>
            ...
            <p
                className={`title select-none text-center text-primary font-bold`}
            >
                {t('market.explore')}
            </p>
        </div>
